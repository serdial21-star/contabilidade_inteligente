(function startApplication(root) {
  ...
  app.addEventListener('click', async (event) => {
    ...
    if (action === 'begin-login') {
      ...
      renderShell(false); document.querySelector('[data-action="toggle-sidebar"]')?.focus();
    }
