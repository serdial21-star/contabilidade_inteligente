...
@pytest.fixture
def serial_migration_engine(migration_lab_at_revision: object) -> object:
    with migration_lab_at_revision('base') as engine:  # type: ignore[operator]
        yield engine


@pytest.mark.mariadb_migration
def test_migration_lab_full_serial_cycle(serial_migration_engine: object) -> None:
    ...
    try:
        ...
        with serial_migration_engine.connect() as connection:  # type: ignore[attr-defined]
