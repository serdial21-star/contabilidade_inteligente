...
def decide(request:ApprovalRequest,step:ApprovalStep,actor_id:UUID,revision_hash:str,now:datetime,*,authorized:bool,existing:tuple[ApprovalDecision,...])->ApprovalDecision:
 ...
 return ApprovalDecision(uuid4(),request.id,step.id,actor_id,'APPROVED',revision_hash,now)
