...
class BankingRepository(Protocol):
    def list_accounts(self, tenant_id: UUID, company_id: UUID) -> tuple[BankAccount, ...]: ...
    def get_account(self, tenant_id: UUID, company_id: UUID, account_id: UUID) -> BankAccount | None: ...
    def find_account(self, tenant_id: UUID, company_id: UUID, external_identity: str) -> BankAccount | None: ...
    def find_account_any(self, tenant_id: UUID, company_id: UUID, external_identity: str) -> BankAccount | None: ...
